...
def sanitize_csv(self, csv_string: str) -> str:
...
def create_simplified_cleaning_prompt(self, sample_csv: str, table_name: str) -> str:
        """Create a simplified prompt that's more likely to generate valid JSON"""
        sample_csv = self.sanitize_csv(sample_csv)
